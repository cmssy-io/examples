...
export const proseBlock = defineBlock({
  ...
  component: Prose,
  props: proseProps,
  // In this app the loader runs in the browser, so the allow-list ships in the
  // bundle and a visitor could skip it. The cmssy delivery API is the boundary
  // that matters - this keeps the markup tidy, it does not make it trusted.
